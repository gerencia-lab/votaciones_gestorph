...
export const AdminActaIATab: React.FC = () => {
    ...
    // Bases de auditoría (mismas que ProjectionView y MinutesPreview)
                            ...
                            <section className="print:break-before-page">
                                ...
                                <div>
                                    {asambleaPreguntas.map((p, idx) => {
                                        ...
                                        // KPIs idénticos a ProjectionView / MinutesPreview
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ border: '1px solid #cbd5e1', padding: '6px 8px', textAlign: 'left', backgroundColor: '#f1f5f9' }}>Asambleísta</th>
